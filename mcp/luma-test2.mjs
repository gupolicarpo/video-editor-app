...
const SEG = 'C:/Users/gupol/AppData/Roaming/video-editor-app/generated/_luma_seg2.mp4'
const OUT = 'C:/Users/gupol/AppData/Roaming/video-editor-app/generated/luma-edit-test2.mp4'
// Identity-locked: keep the exact same man and room, only change the lighting.
const PROMPT =
  'Keep this exact man unchanged — same face, same beard, same black beanie, same black t-shirt, sitting in the same room with the same furniture and objects. Do NOT change his identity, body, clothing or the scene. Only improve the lighting: add a soft professional studio key light from the front-left, gentle fill light, natural warm and even skin tones, slightly brighter and more flattering. Photorealistic, crisp, cinematic, high-end. Same camera, same composition, same motion.'
...
async function main() {
  ...
  console.log('2/4 enviando video_edit (identidade travada)...')
